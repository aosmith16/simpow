...
Change the `simfun` to explore  a different simulation function. For `lm_2f()` for limited-block-number designs this will probably be most useful for varying the number of replicates per treatment per block or residual standard deviation. 
